...
- **Intelligent Multi-Task Splitting**: Uses natural language processing rules to split multi-item dictated phrases into distinct task items automatically:
  - *Example*: Dictating `"Buy provisions and call mom"` automatically creates 2 tasks: `"Buy provisions"` and `"Call mom"`.
  - *Example*: Dictating `"1. Pick up dry cleaning 2. Pay electric bill 3. Schedule dentist"` creates 3 separate tasks.
