...
- **Intelligent Multi-Task Splitting**: Uses natural language processing rules (and optional OpenAI API integration) to split multi-item dictated phrases into distinct task items automatically:
...
|                Task List (Empty State)                |            Task List (Active & Completed)             |                     Add Task Form                     |
| :---------------------------------------------------: | :---------------------------------------------------: | :---------------------------------------------------: |
| ![Task List Empty](./screenshots/task_list_empty.png) | ![Task List Mixed](./screenshots/task_list_mixed.png) | ![Add Task Screen](./screenshots/add_task_screen.png) |

|               Voice FAB Dictation Mode                |               Dark Theme Mode               |
| :---------------------------------------------------: | :-----------------------------------------: |
| ![Voice Mode FAB](./screenshots/voice_input_mode.png) | ![Dark Theme](./screenshots/dark_theme.png) |
